/*
	DATASET_NETFLIX_ORIG.H
	----------------------
*/
#include <stdio.h>
#include "dataset.h"

#ifndef DATASET_NETFLIX_ORIG_H_
#define DATASET_NETFLIX_ORIG_H_

class CSP_dataset_netflix_orig : public CSP_dataset
{
public:
	CSP_dataset_netflix_orig(CSP_param_block *params);
	virtual ~CSP_dataset_netflix_orig() {}
